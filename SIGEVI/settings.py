"""
Django settings for SIGEVI project.
...
SECRET_KEY = 'django-insecure-hbkfxt5j4j-(&42p!xd(!lyb0n8%(&r6msja!(3n+)z1$mt%er'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'carrito.context_prossesor.total_carrito',
            ],
        },
    },
]

WSGI_APPLICATION = 'SIGEVI.wsgi.application'
